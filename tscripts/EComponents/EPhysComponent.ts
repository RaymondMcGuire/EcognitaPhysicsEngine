...
module EPSE {
    ...
    export class EPhysComponent extends ECS.Component {
        ...
        getForce() {
            let f = new THREE.Vector3(0, 0, - this.mass * g);
            return f;
        }
        ...
        getEnergy() {
            ...
            let v2 = this.v.lengthSq();

            let kinetic = 1 / 2 * this.mass * v2;

            let z = (this.step === 0) ? this.r.z : this.r_1.z;

            let potential = this.mass * g * z;
